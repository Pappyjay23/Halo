					...
					<AnimatePresence>
						{isHovering && (
							<div>
								...
								{/* 🔥 Lens Border */}
								<motion.div
									className='absolute pointer-events-none rounded-full border border-white/30 shadow-[0_0_10px_rgba(255,255,255,0.4)]'
									style={{
										width: lensSize,
										height: lensSize,
